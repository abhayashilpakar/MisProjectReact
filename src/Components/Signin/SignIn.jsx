  ...
  return (
    <>
      <div class="flex w-screen flex-wrap text-slate-800">
        <div class="relative hidden  select-none flex-col justify-center bg-blue-600 text-center md:flex md:w-1/2">
          <div class="mx-auto py-16 px-8 text-white xl:w-[40rem]">
            ...
            <p class="my-6 text-3xl font-semibold leading-10">
              ...
              <span class="mx-auto block w-56 whitespace-nowrap rounded-lg bg-orange-400 py-2 text-white">
                drag and drop
              </span>
            </p>
            <p class="mb-4">
          ...
          <img
            class="mx-auto w-11/12 max-w-lg rounded-lg object-cover"
            src="/images/SoOmmtD2P6rjV76JvJTc6.png"
            alt=""
          />
        </div>
        <div class="flex w-full flex-col md:w-1/2 ">
          <div class="flex justify-center pt-5 md:justify-start md:pl-12">
            <a href="a" class="text-2xl font-bold text-blue-600">
              Wobble .
            </a>
          </div>
          <div class="my-auto mx-auto flex flex-col justify-center px-6 pt-8 md:justify-start lg:w-[28rem]">
            ...
            <p class="mt-6 text-center font-medium md:text-left">
              ...
              <a href="a" class="whitespace-nowrap font-semibold text-blue-700">
                Login here
              </a>
            </p>
